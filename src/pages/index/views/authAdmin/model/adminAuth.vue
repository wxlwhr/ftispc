<template>
  <div class="adminAuth">
    ...
    <!-- 关联菜单 -->
    <relaUser ref="roleRelaDialog"></relaUser>
  </div>
</template>

<script>
import utils from "@/util/util";
import relaUser from "../../authAdmin/components/rela-user";
import { getUserRole } from "@/api/api.js";
export default {
  components: {relaUser},
  props: {},
  data() {
  ...
  methods: {
    getRoleList(page){
      ...
      getUserRole(data).then(function (response) {
