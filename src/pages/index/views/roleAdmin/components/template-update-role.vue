  ...
  <div class="wrapper">
    ...
    <el-form ref="ruleForm" :model="ruleForm" label-width="auto" status-icon :rules="rules">
      <el-form-item prop="role_bel_type" placeholder="请输入" label="角色所属:">
        <Slt :listParameter="roleBelType" class="select_box" :select-value="ruleForm.role_bel_type"></Slt>
      </el-form-item>
      ...
      <el-form-item prop="audit_type" label="审批模式:">
        <Slt :listParameter="auditType" class="select_box" :select-value="ruleForm.audit_type"></Slt>
      </el-form-item>
    </el-form>
