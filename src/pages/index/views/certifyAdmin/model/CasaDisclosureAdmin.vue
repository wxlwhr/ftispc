...
<template>
  <div class="wrapper">
    <el-container class="organ_menu">
      <el-header height="57px">解决方案披露</el-header>
      <el-container>
  ...
  methods: {
    ...
    addTreeNode(e) {
      ...
      if(this.nodeData){
        ...
        this.$refs.myclass.parentHandleclick(this.catalog_id);
    ...
    handleDelete(val) {
      ...
      this.$confirm("此操作将永久删除该目录, 是否继续?", "提示", {
        ...
        .then(() => {
          // 删除请求
          deleteCase({ case_id: val.case_id }).then(function (response) {
            ...
            if (response.code == "1") {
              ...
              that.getSearchCaseByCatalogs(val.catalog_id)
            } else {
